...
const getItemsByMenu = (menuData, menuName) => {
    return menuData.filter((item) => item.menu === menuName);
};
...
const MenuPage = () => {
    ...
    useEffect(() => {
        ...
        const defaultMenuItems = getItemsByMenu(PRODUCTS, defaultMenu);
        setSelectedMenu({
            name: defaultMenu,
    ...
    const handleSelectMenu = (menuName) => {
        const selectedMenuItems = getItemsByMenu(PRODUCTS, menuName);
        setSelectedMenu({
            name: menuName,
    ...
    return (
        <div className='page-wrapper'>
            <MenuNav onSelectMenu={handleSelectMenu} selectedMenuId={selectedMenu?.name} />
